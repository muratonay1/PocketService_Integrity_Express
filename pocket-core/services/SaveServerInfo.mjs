import { Modules, MongoQueryFrom, Operator, Status, PocketLib } from "../util/constants.js";
...
const SaveServerInfo = execute(async (criteria) => {
     try {
          ...
          const serviceResponse = await PocketService.executeService(`GetServerInfo`, "pocket-core", Pocket.create());
          let getData;
